...
const Footer = () => {
  return (
    <section className={`py-4 overflow w-[100%] h-[100%] dark:bg-slate-900 mt-[187.9px]`}>
    <div className={`${layout.sectionInfo} ${styles.flexCenter} w-[100%] h-[100%] overflow min-w-max bg-zinc-800 dark:bg-slate-900 justify-center`}>
