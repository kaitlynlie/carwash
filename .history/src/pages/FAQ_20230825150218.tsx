...
function Accordion() {
  ...
  const getClassAnswer = (id) => {
    return activeQ === id ? "${clsx(styles.active-answer)}" : "";
  };
            ...
            <div className={clsx(styles.accord)}>
              ...
              <div className={clsx(styles.accorditem)}>
                ...
                <div
                  id="q2"
                  onClick={() => openQ("q2")}
                  className={`${clsx(styles.accorda)} ${getClassAnswer("q2")}`}
                >
              ...
              <div className={clsx(styles.accorditem)}>
                <div
                  id="q3"
                  onClick={() => openQ("q3")}
                  className={`${clsx(styles.accordq)} ${getClassQuestion("q3")}`}
                >
                ...
                <div
                  id="q3"
                  onClick={() => openQ("q3")}
                  className={`${clsx(styles.accorda)} ${getClassAnswer("q3")}`}
                >
