...
function Footer() {
  <section className={clsx(styles.footer)}>
      ...
      <div className="flex items-center sm:justify-between flex-wrap gap-5">
        <h4 className="font-bold md:text-[64px] text-[44px] text-white">Stay Up to Date</h4> 
        <button type="button" className="flex items-center h-fit py-4 px-6 bg-[#25618b] rounded-[32px] gap-[12px]">
          <img src='/logo.svg' alt='logo' className="w-[24px] h-[24px] object-contains"/>
          <span className="font-normal text-[16px] text-white">Sign Up</span>
        </button>
      </div>
      ...
      <div className="flex flex-col">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <h4 className="font-extrabold text-[24px] text-white">GALAXIA</h4>
