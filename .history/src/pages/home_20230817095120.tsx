    ...
    <section className={clsx(styles.header)}>
      <div className={clsx(styles.info)}>
        ...
        <div className={clsx(styles.buttons)}>
          <a href="" className={clsx(styles.links, styles.light)}>
            <div className={clsx(styles.icon, styles.light)}>
              <img
          ...
          <a href="" className={clsx(styles.links, styles.dark)}>
            <div className={clsx(styles.icon, styles.dark)}>
              <img
  ...
  return (
    <section className={clsx(styles.download)}>
      <div className={clsx(styles.info)}>
        ...
        <div className={clsx(styles.buttons)}>
          <a href="" className={clsx(styles.light)}>
            <div className={clsx(styles.download)}>
              <img src={lightapple} className={clsx(styles.icon)} />
              <p>MacOS Intel v0.4.1</p>
              <img src={lightdownload} className={clsx(styles.dlicon)} />
            </div>
          </a>

          <a href="" className={clsx(styles.dark)}>
            <div className={clsx(styles.download)}>
          ...
          <a href="" className={(clsx(styles.light))}>
            <div className={clsx(styles.download)}>
              <img src={lightchrome} className={clsx(styles.icon)} />
              <p>Chrome</p>
              <img src={lightdownload} className={clsx(styles.dlicon)} />
            </div>
          </a>
        ...
        <div className={clsx(styles.buttons)}>
          <a href="" className={clsx(styles.light)}>
            <div className={clsx(styles.download)}>
              <img src={lightappstore} className={clsx(styles.icon)} />
          ...
          <a href="" className={clsx(styles.light)}>
            <div className={clsx(styles.download)}>
              <img src={lightandroid} className={clsx(styles.icon)} />
              <p>Google Store</p>
              <img src={lightdownload} className={clsx(styles.dlicon)} />
            </div>
          </a>
