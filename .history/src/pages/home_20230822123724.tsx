...
import { logo, hero, tracks, location, bubbles, rain } from "../assets";
  ...
  return(
    <section className={clsx(styles.testimonials)}>
      <div className={clsx(styles.container)}>
        <h4>REVIEWS</h4>
        <div className={clsx(styles.title)}>
            <h2 className="font-extrabold text-white sm:text-[32px] text-[20px]">Testimonials by our Customers</h2>
      ...
      <div className='justify-between justify-center flex-row max-[1240px]:flex-col flex gap-20 mt-10'>
        ...
        <div className='bg-gray-300 shadow-xl flex-1'>
            <p className='mt-10 text-black font-medium text-2xl mx-10'>"Been using it for a few months now. PC looks great and runs every game I play very nicely. Customer service was top notch, had great communication all the way."</p>
