...
export function Home() {
  return (
    <>
      ...
      <div className={`bg-zinc-800 ${stylesTw.flexStart}`}>
        <Footer />
      </div>
    </>
  );
  ...
  return (
    <nav className={clsx(styles.navbar)}>
      <div className={clsx(styles.logo)}>
        ...
        />
        <h2 className={clsx(styles.heading)}>TapSafe</h2>
      </div>

      <div id='theme-switcher' onClick={handleThemeSwitch} className={clsx(styles.themeswitch)}>
        <svg className={clsx(styles.sun)} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" id='icon-sun'>
        ...
        <svg className={clsx(styles.moon)} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" id='icon-moon'>
