    ...
    <section className={clsx(styles.testimonials)}>
      ...
      <div className={clsx(styles.cards)}>
        <div className={clsx(styles.card)}>
            <h3>"Been using it for a few months now. PC looks great and runs every game I play very nicely. Customer service was top notch, had great communication all the way."</h3>
                <div className={clsx(styles.customer)}>
                 <img src={person1} />
                    <div className={clsx(styles.text)}>
                        <h4 className='mt-10 font-bold'>Valued Customer</h4>
                        <p>Nereid</p>
                    </div>
                </div>
        </div>
        ...
        <div className={clsx(styles.card)}>
            <h3>"Works great, fast, and quiet. Shipped super secure. No problems with it for streaming any game. Very glad with our selection and happy with purchase."</h3>
