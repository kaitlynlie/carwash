  ...
  return (
    <section className={clsx(styles.hero)}>
      <div className={clsx(styles.header)}>
        ...
        <h2>Save big with our all new membership deals!</h2>
        <p>With unbeatable prices, unlimited washes, we'll give you the shiniest car wash and onto the road quickly. </p>
      </div>
