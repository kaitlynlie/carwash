    ...
    <section className={clsx(styles.testimonials)}>
      ...
      <div className={clsx(styles.cards)}>
        <div className={clsx(styles.card)}>
            <h3>"Amazing wash, loved the vaccuums afterwards. Affordable, and my car was super clean afterwards."</h3>
        ...
        <div className={clsx(styles.card)}>
            <h3>"I was traveling across the country and had so many bugs on my car, thank goodness for Big Bad Carwash! The staff are also super friendly and accomodating"</h3>
                <div className={clsx(styles.customer)}>
                 <img src={person2}/>
                    <div className={clsx(styles.text)}>
                        <h4>Valued Customer</h4>
